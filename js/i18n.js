...
const I18N = {
  en: {
    ...
    "Ortnamn": "Local place names",
    "Byns egna namn på vikar, myrar, älgpass och ängar":
      "The village's own names for bays, mires, elk stands and meadows",
    "Visar ortnamn ur muntlig tradition…": "Showing place names from oral tradition…",
    "Namnge en plats": "Name a place",
    "Många vikar, myrar och älgpass har namn som bara används i byn och inte står på någon karta. Skriv in dem här så finns de kvar.":
      "Many bays, mires and elk stands have names used only in the village and shown on no map. Record them here so they survive.",
    "Namnet": "The name",
    "Vad är det?": "What is it?",
    "Språk": "Language",
    "Svenska": "Swedish",
    "Sydsamiska": "South Sami",
    "Sydsamiskt namn": "South Sami name",
    "Bakgrund (valfritt)": "Background (optional)",
    "Varför heter den så? Vad har hänt här?": "Why is it called that? What happened here?",
    "Berättat av (valfritt)": "Told by (optional)",
    "Berättat av": "Told by",
    "T.ex. Erik Persson, f. 1938": "E.g. Erik Persson, b. 1938",
    "T.ex. Lillviken": "E.g. Lillviken",
    ...
    "Bra — skriv namnet nu.": "Good — now enter the name.",
    "Den vyn saknas — starta om appen så hämtas den senaste versionen.":
      "That view is missing — restart the app to get the latest version.",
    "Skriv namnet först.": "Enter the name first.",
    "Platsen saknas — peka ut den på kartan.": "No location — point it out on the map.",
    "Namnet är sparat. Tack — det finns kvar nu.": "Name saved. Thank you — it is preserved now.",
    "Databasen saknar tabellen — kör supabase/ortnamn.sql.":
      "The database is missing the table — run supabase/ortnamn.sql.",
    "Ta bort namnet?": "Delete this name?",
    "Namn ur muntlig tradition i Kultsjödalen": "A name from oral tradition in Kultsjödalen",
    "Mina ortnamn": "My place names",
    "Vik": "Bay", "Myr": "Mire", "Holme": "Islet", "Tjärn": "Tarn",
    "Äng": "Meadow", "Slåtterland": "Hay meadow", "Fiskeställe": "Fishing spot",
    "Älgpass": "Elk stand", "Annat": "Other",
    ...
    "Idag": "Today",
    "Imorgon": "Tomorrow",
    "Prognos från SMHI. Vindbyar inom parentes, nederbörd som dygnsmängd.":
      "Forecast from SMHI. Gusts in parentheses, precipitation as daily total.",
    ...
    "+ Lägg till i Bo & äta": "+ Add to Stay & eat",
    "Integritetspolicy": "Privacy policy",
    "Toppar i området": "Peaks in the area",
    "toppar": "peaks",
    "tryck för lista": "tap for list",
    ...
    "Avbryt": "Cancel",
    "Nytt läge sparat.": "New location saved.",
    "Mina uppgifter": "My data",
    "Mina tips": "My tips",
    "Mina bilder på platser": "My photos on places",
    "Mina kommentarer": "My comments",
    "Mina delade turer": "My shared routes",
    "Ta bort? Detta går inte att ångra.": "Delete? This cannot be undone.",
    "Borttaget.": "Deleted.",
    "Kunde inte ta bort: ": "Could not delete: ",
    "Kunde inte hämta ditt innehåll: ": "Could not load your content: ",
    "Laddar…": "Loading…",
    "Samlar ihop dina data…": "Gathering your data…",
    "Klart — filen är nedladdad.": "Done — file downloaded.",
    "Kunde inte hämta data: ": "Could not fetch data: ",
    "Kryssa i att du godkänner integritetspolicyn först.": "Please tick the box accepting the privacy policy first.",
    "Radera ditt konto och ALLT du delat (tips, foton, kommentarer, turer)? Detta går inte att ångra.":
      "Delete your account and EVERYTHING you have shared (tips, photos, comments, routes)? This cannot be undone.",
    "Skriv din e-postadress för att bekräfta raderingen:": "Type your email address to confirm deletion:",
    "E-postadressen stämde inte — inget raderades.": "The email address did not match — nothing was deleted.",
    "Raderar konto…": "Deleting account…",
